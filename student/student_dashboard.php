...
<body>
    <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" aria-current="page" href="attandance_status.php"  >Display Attandance</a>
                        </li>
                        <li class="nav-item">

                            <a class="nav-link active" aria-current="page" href="show_marks.php"  >Display Marks </a>
                        </li>                        
                        
                        <li class="nav-item">

                            <a class="nav-link active" aria-current="page" href="resources.php"  >Resources</a>
                        </li>          
                        <li class="nav-item">

                            <a class="nav-link active" aria-current="page" href="inbox.php"  >Inbox</a>
                        </li>
        ...
        <?php
            ...
            $query="select image from student_details where sid='{$_SESSION["sid"]}'";
        ...
        ?>
            <div class="admin-img"><img src=" <?php echo "$image"; ?>" height="200px"width="150px" alt="Not found"><?php echo  "<br>".strtoupper($_SESSION["first_name"]); ?></div>
            <div class="admin-detail">

                <!-- code for fetching data form database -->
                <?php
                    
                    $query="select * from student_details where sid='{$_SESSION['sid']}'";
                    $result=mysqli_query($conn,$query);
                    $row=mysqli_fetch_assoc($result);
                    $email=$row['email'];
