...
?>
    <h1 align="center" style="margin-bottom:20px;">Sent Mail</h1>
        ...
        <h6 align="center ">Select Recivers</h6>
            ...
            <form class="row g-3" style="padding:0px 12px;"method="POST" action="add_fac.php" enctype="multipart/form-data">
                ...
                <!-- <div class="form-floating mb-3 col-md-4">
                    <input type="text" name="id" class="form-control in" id="floatingInput" placeholder="enter uid">
                    <label for="floatingInput">Sent Mail to Specific Person </label>
                 </div> -->
                 
                <h6 align="center">Mail Content</h6>
                <div class="form-floating mb-3 col-md-10">
                    <input type="text" name="subject" class="form-control" id="floatingInput" placeholder="Subject of mail">
                ...
                <div class="col-md-10 ">
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Sent Attachments</label>
                ...
                <div class="form-floating">
                    <textarea name="mailbody" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 350px"></textarea>
                ...
                <div class="col-12" align="center">
                    <button name="msub" type="submit" class="btn btn-primary">Sent Mail</button>
                </div>
            </form>
