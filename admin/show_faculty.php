...
<h1 align="center" class="student_reg_hed">Faculty Detail </h1>
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ?>
                        <tr>
                            ...
                            <td><?php echo $row['fid'];   ?></th>
                            <td><?php echo $row['department'];   ?></th>
                            <td><?php echo $row['mobile'];   ?></th>
                            <td><?php echo $row['email'];   ?></th>
                            <td ><a href=<?php echo "full_faculty_detail.php?fid={$row['fid']}"; ?>><button type="button"  class="btn btn-outline-info">Show</button> </a></td>
                        </tr>
                    <?php
